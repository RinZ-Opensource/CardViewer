...
export function HoloMaterialLayer({
  ...
  return (
    <div
      ...
      style={lightStyle}
      data-holo-state={maskState?.status}
      data-holo-error={maskState?.status === "error" ? maskState.error : undefined}
...
export function useOfficialHoloMask(input: HoloMaskInput, enabled: boolean) {
  ...
  // render-ready. The effect will install the matching pending state next.
