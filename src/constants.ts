...
export const STATIC_MANIFEST_URL = "/official/generated/cards.json";
...
// This repository has one supported runtime: the public Cloudflare Web app.
// The assertion preserves the legacy renderer's union type while keeping the
// compiled value fail-closed and immune to ambient Vite environment overrides.
...
export const CANVAS_FONT_SEGA_MARU_DB =
  '"CardViewer Zen Maru", "Yu Gothic", "Meiryo", "Segoe UI", sans-serif';
...
/**
 * Versioned, R2-backed runtime assets shared by every card renderer. The
 * repository deliberately contains no copies of these images or font atlases.
 */
export const OFFICIAL_ASSET_ROOT = "/official/cardviewer/v1/runtime/";
export const OFFICIAL_FONT_ROOT = "/official/cardviewer/v1/fonts/";
